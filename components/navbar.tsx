      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-14 md:h-16">
          ...
          <div className="hidden md:flex items-center space-x-3">
            <LanguageSelector className="w-20 bg-gray-100 dark:bg-gray-800 rounded-md text-xs capitalize" />
            <BookMeetingButton className="text-xs px-3 py-1.5 capitalize" />
            <ModeToggle />
          </div>
              ...
              {navItems.map((item) =>
                item.dropdown ? (
                  ...
                  <Link
                    key={item.href}
                    href={item.href}
                    className={`text-gray-700 hover:text-blue-600 block px-4 py-3 rounded-md text-base font-medium transition-colors duration-200 capitalize ${
