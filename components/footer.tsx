      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="col-span-1 md:col-span-1">
            <h3 className="text-lg font-semibold mb-4">Densight AI</h3>
            <p className="text-gray-600 dark:text-gray-400 mb-4">
              Transforming businesses with AI-powered insights and data-driven solutions.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-start">
                ...
                <span>+971564468736</span>
              </li>
              <li className="flex items-start">
                <Mail className="h-5 w-5 text-blue-600 mr-2 mt-0.5" />
                <span>info@densight.ai</span>
              </li>
              <li className="flex items-start">
          ...
          <div>
            ...
            <div className="flex">
              <input
                ...
                className="px-4 py-2 w-full border border-gray-300 dark:border-gray-700 rounded-l-md focus:outline-none focus:ring-2 focus:ring-blue-500 dark:bg-gray-800 dark:text-white"
              />
        ...
        <div className="mt-8 pt-8 border-t border-gray-200 dark:border-gray-800 text-center text-gray-500 dark:text-gray-400">
          <p>© {new Date().getFullYear()} Densight AI. All rights reserved.</p>
        </div>
      </div>
    </footer>
  )
