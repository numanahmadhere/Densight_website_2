...
export default function IndustriesOverview({ className, compact = false }: { className?: string; compact?: boolean }) {
  return (
    <section className={`py-12 ${compact ? "bg-transparent" : "bg-gray-50"} ${className}`}>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div
          className={`grid ${compact ? "grid-cols-2 sm:grid-cols-3 md:grid-cols-4" : "grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-7"} gap-4 mb-6`}
        >
